...
describe 'tools routes', :type => :routing do
  ...
  it "GET /tools/json_web_token should route to 'tools#json_web_token'" do
    expect(:get => '/tools/json_web_token').
        to route_to(:controller => 'tools',
                    :action => 'json_web_token')
  end

  it "POST /tools/json_web_token should route to 'tools#json_web_token'" do
    expect(:post => '/tools/json_web_token').
        to route_to(:controller => 'tools',
                    :action => 'json_web_token')
  end
end
